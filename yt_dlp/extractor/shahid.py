...
class ShahidBaseIE(AWSIE):
    ...
    # Removed hardcoded API key to avoid distributing secrets
    _AWS_API_KEY = None
    ...
    def _call_api(self, path, video_id, request=None):
        ...
        try:
            access_key = os.environ.get('SHAHID_AWS_ACCESS_KEY')
            secret_key = os.environ.get('SHAHID_AWS_SECRET_KEY')
            if not access_key or not secret_key:
                raise ExtractorError('Shahid extractor disabled: missing AWS credentials', expected=True)
